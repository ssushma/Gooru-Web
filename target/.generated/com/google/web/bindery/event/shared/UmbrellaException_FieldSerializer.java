...
public class UmbrellaException_FieldSerializer implements com.google.gwt.user.client.rpc.impl.TypeHandler {
  private static java.util.Set getCauses(com.google.web.bindery.event.shared.UmbrellaException instance) {
    return (java.util.Set) ReflectionHelper.getField(com.google.web.bindery.event.shared.UmbrellaException.class, instance, "causes");
  }
  
  private static void setCauses(com.google.web.bindery.event.shared.UmbrellaException instance, java.util.Set value) 
  {
    ReflectionHelper.setField(com.google.web.bindery.event.shared.UmbrellaException.class, instance, "causes", value);
  }
