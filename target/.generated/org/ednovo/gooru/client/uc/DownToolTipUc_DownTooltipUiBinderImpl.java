...
public class DownToolTipUc_DownTooltipUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, org.ednovo.gooru.client.uc.DownToolTipUc>, org.ednovo.gooru.client.uc.DownToolTipUc.DownTooltipUiBinder {


  public com.google.gwt.user.client.ui.Widget createAndBindUi(final org.ednovo.gooru.client.uc.DownToolTipUc owner) {
   ...
   */
  class Widgets {
    private final org.ednovo.gooru.client.uc.DownToolTipUc owner;


    public Widgets(final org.ednovo.gooru.client.uc.DownToolTipUc owner) {
      this.owner = owner;
     ...
     */
    private org.ednovo.gooru.client.uc.DownToolTipUc_DownTooltipUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private org.ednovo.gooru.client.uc.DownToolTipUc_DownTooltipUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final org.ednovo.gooru.client.uc.DownToolTipUc_DownTooltipUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (org.ednovo.gooru.client.uc.DownToolTipUc_DownTooltipUiBinderImpl_GenBundle) GWT.create(org.ednovo.gooru.client.uc.DownToolTipUc_DownTooltipUiBinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.FlowPanel build_f_FlowPanel1() {
      ...
      f_FlowPanel1.setStyleName("" + get_res().css().popup() + "");
    ...
    private com.google.gwt.user.client.ui.SimplePanel build_f_SimplePanel2() {
      ...
      // Setup section.
      f_SimplePanel2.setStyleName("" + get_res().css().header() + "");
    ...
    private com.google.gwt.user.client.ui.SimplePanel build_contentPanel() {
      ...
      // Setup section.
      contentPanel.setStyleName("" + get_res().css().content() + "");
