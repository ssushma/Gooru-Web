...
public class AssignmentEditLabelUc_AssignmentEditLabelUcUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, org.ednovo.gooru.client.uc.AssignmentEditLabelUc>, org.ednovo.gooru.client.uc.AssignmentEditLabelUc.AssignmentEditLabelUcUiBinder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final org.ednovo.gooru.client.uc.AssignmentEditLabelUc owner) {
   ...
   */
  class Widgets {
    private final org.ednovo.gooru.client.uc.AssignmentEditLabelUc owner;


    public Widgets(final org.ednovo.gooru.client.uc.AssignmentEditLabelUc owner) {
      this.owner = owner;
     ...
     */
    private org.ednovo.gooru.client.uc.AssignmentEditLabelUc_AssignmentEditLabelUcUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private org.ednovo.gooru.client.uc.AssignmentEditLabelUc_AssignmentEditLabelUcUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final org.ednovo.gooru.client.uc.AssignmentEditLabelUc_AssignmentEditLabelUcUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (org.ednovo.gooru.client.uc.AssignmentEditLabelUc_AssignmentEditLabelUcUiBinderImpl_GenBundle) GWT.create(org.ednovo.gooru.client.uc.AssignmentEditLabelUc_AssignmentEditLabelUcUiBinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord2116 = UiBinderUtil.attachToDom(f_HTMLPanel1.getElement());
      get_domId0Element().get();
      get_domId1Element().get();

      // Detach section.
      attachRecord2116.detach();
    ...
    private com.google.gwt.user.client.ui.FocusPanel build_focusPanel() {
      ...
      focusPanel.setStyleName("" + get_res().css().editableFieldforClspage() + "");
    ...
    private com.google.gwt.user.client.ui.Label build_editLabel() {
      ...
      // Setup section.
      editLabel.setStyleName("" + get_res().css().editableFieldforClspage() + "");
    ...
    private com.google.gwt.user.client.ui.Label build_errorLabel() {
      ...
      // Setup section.
      errorLabel.setStyleName("" + get_res().css().errorValidationClassPage() + "");
