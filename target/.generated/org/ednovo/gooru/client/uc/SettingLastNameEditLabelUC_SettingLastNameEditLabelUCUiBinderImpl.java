...
public class SettingLastNameEditLabelUC_SettingLastNameEditLabelUCUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, org.ednovo.gooru.client.uc.SettingLastNameEditLabelUC>, org.ednovo.gooru.client.uc.SettingLastNameEditLabelUC.SettingLastNameEditLabelUCUiBinder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final org.ednovo.gooru.client.uc.SettingLastNameEditLabelUC owner) {
   ...
   */
  class Widgets {
    private final org.ednovo.gooru.client.uc.SettingLastNameEditLabelUC owner;


    public Widgets(final org.ednovo.gooru.client.uc.SettingLastNameEditLabelUC owner) {
      this.owner = owner;
     ...
     */
    private org.ednovo.gooru.client.uc.SettingLastNameEditLabelUC_SettingLastNameEditLabelUCUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private org.ednovo.gooru.client.uc.SettingLastNameEditLabelUC_SettingLastNameEditLabelUCUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final org.ednovo.gooru.client.uc.SettingLastNameEditLabelUC_SettingLastNameEditLabelUCUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (org.ednovo.gooru.client.uc.SettingLastNameEditLabelUC_SettingLastNameEditLabelUCUiBinderImpl_GenBundle) GWT.create(org.ednovo.gooru.client.uc.SettingLastNameEditLabelUC_SettingLastNameEditLabelUCUiBinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord1336 = UiBinderUtil.attachToDom(f_HTMLPanel1.getElement());
      get_domId0Element().get();
      get_domId1Element().get();

      // Detach section.
      attachRecord1336.detach();
    ...
    private com.google.gwt.user.client.ui.FocusPanel build_focusPanel() {
      ...
      focusPanel.setStyleName("" + get_res().css().editableFieldlastNameSetting() + "");
    ...
    private com.google.gwt.user.client.ui.Label build_errorLabel() {
      ...
      // Setup section.
      errorLabel.setStyleName("" + get_res().css().errorValidationSetting() + "");
