...
public class SearchMoreInfoVc_SearchMoreInfoVcUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, org.ednovo.gooru.client.mvp.search.SearchMoreInfoVc<?, ?>>, org.ednovo.gooru.client.mvp.search.SearchMoreInfoVc.SearchMoreInfoVcUiBinder {


  public com.google.gwt.user.client.ui.Widget createAndBindUi(final org.ednovo.gooru.client.mvp.search.SearchMoreInfoVc<?, ?> owner) {
   ...
   */
  class Widgets {
    private final org.ednovo.gooru.client.mvp.search.SearchMoreInfoVc<?, ?> owner;


    public Widgets(final org.ednovo.gooru.client.mvp.search.SearchMoreInfoVc<?, ?> owner) {
      this.owner = owner;
     ...
     */
    private org.ednovo.gooru.client.mvp.search.SearchMoreInfoVc_SearchMoreInfoVcUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private org.ednovo.gooru.client.mvp.search.SearchMoreInfoVc_SearchMoreInfoVcUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final org.ednovo.gooru.client.mvp.search.SearchMoreInfoVc_SearchMoreInfoVcUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (org.ednovo.gooru.client.mvp.search.SearchMoreInfoVc_SearchMoreInfoVcUiBinderImpl_GenBundle) GWT.create(org.ednovo.gooru.client.mvp.search.SearchMoreInfoVc_SearchMoreInfoVcUiBinderImpl_GenBundle.class);
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.ScrollPanel build_resourceScrPanel() {
      ...
      resourceScrPanel.setStyleName("" + get_res().css().moreInfoRightScrollPanel() + "");
