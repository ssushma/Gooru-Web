...
public class CollectionFormView_CollectionFormViewUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, org.ednovo.gooru.client.mvp.shelf.collection.CollectionFormView>, org.ednovo.gooru.client.mvp.shelf.collection.CollectionFormView.CollectionFormViewUiBinder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final org.ednovo.gooru.client.mvp.shelf.collection.CollectionFormView owner) {
   ...
   */
  class Widgets {
    private final org.ednovo.gooru.client.mvp.shelf.collection.CollectionFormView owner;


    public Widgets(final org.ednovo.gooru.client.mvp.shelf.collection.CollectionFormView owner) {
      this.owner = owner;
     ...
     */
    private org.ednovo.gooru.client.mvp.shelf.collection.CollectionFormView_CollectionFormViewUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private org.ednovo.gooru.client.mvp.shelf.collection.CollectionFormView_CollectionFormViewUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final org.ednovo.gooru.client.mvp.shelf.collection.CollectionFormView_CollectionFormViewUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (org.ednovo.gooru.client.mvp.shelf.collection.CollectionFormView_CollectionFormViewUiBinderImpl_GenBundle) GWT.create(org.ednovo.gooru.client.mvp.shelf.collection.CollectionFormView_CollectionFormViewUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private org.ednovo.gooru.client.mvp.shelf.collection.CollectionFormView_CollectionFormViewUiBinderImpl_GenCss_createCollectionStyle createCollectionStyle;
    private org.ednovo.gooru.client.mvp.shelf.collection.CollectionFormView_CollectionFormViewUiBinderImpl_GenCss_createCollectionStyle get_createCollectionStyle() {
      return createCollectionStyle;
    }
    private org.ednovo.gooru.client.mvp.shelf.collection.CollectionFormView_CollectionFormViewUiBinderImpl_GenCss_createCollectionStyle build_createCollectionStyle() {
      // Creation section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel1() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord226 = UiBinderUtil.attachToDom(f_HTMLPanel1.getElement());
      get_domId0Element().get();

      // Detach section.
      attachRecord226.detach();
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_shelfItemContent() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord227 = UiBinderUtil.attachToDom(shelfItemContent.getElement());
      get_domId1Element().get();

      // Detach section.
      attachRecord227.detach();
      shelfItemContent.addAndReplaceElement(get_f_HTMLPanel2(), get_domId1Element().get());

      owner.shelfItemContent = shelfItemContent;
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel2() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord228 = UiBinderUtil.attachToDom(f_HTMLPanel2.getElement());
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel3() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord229 = UiBinderUtil.attachToDom(f_HTMLPanel3.getElement());
      get_domId5Element().get();
      get_domId6Element().get();

      // Detach section.
      attachRecord229.detach();
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel4() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord230 = UiBinderUtil.attachToDom(f_HTMLPanel4.getElement());
      get_domId7Element().get();
      get_domId8Element().get();

      // Detach section.
      attachRecord230.detach();
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_gradeContainer() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord231 = UiBinderUtil.attachToDom(gradeContainer.getElement());
      get_domId10Element().get();
      get_domId11Element().get();

      // Detach section.
      attachRecord231.detach();
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_courseContainer() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord232 = UiBinderUtil.attachToDom(courseContainer.getElement());
      get_domId13Element().get();
      get_domId14Element().get();

      // Detach section.
      attachRecord232.detach();
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_visibilitySection() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord233 = UiBinderUtil.attachToDom(visibilitySection.getElement());
      get_domId16Element().get();
      get_domId21Element().get();
      get_domId22Element().get();

      // Detach section.
      attachRecord233.detach();
      ...
      owner.visibilitySection = visibilitySection;
    ...
    private org.ednovo.gooru.client.ui.HTMLEventPanel build_publicShareFloPanel() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord234 = UiBinderUtil.attachToDom(publicShareFloPanel.getElement());
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_buttonMainContainer() {
      ...
      // Attach section.
      UiBinderUtil.TempAttachment attachRecord235 = UiBinderUtil.attachToDom(buttonMainContainer.getElement());
      get_domId24Element().get();
      get_domId25Element().get();

      // Detach section.
      attachRecord235.detach();
