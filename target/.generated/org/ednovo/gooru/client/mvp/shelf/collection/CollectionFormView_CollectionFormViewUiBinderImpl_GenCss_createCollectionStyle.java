...
public interface CollectionFormView_CollectionFormViewUiBinderImpl_GenCss_createCollectionStyle extends CssResource {
  String shelfItemHeaderText();
  String shelfItemPopUpOuterDiv();
  String visibilityMainTitle();
  String sourceToolTip();
  String actionField();
  String secondary();
  String publicText();
  String formContainerinput();
  String contentDesc();
