...
public class ExistsResourceView_ExistsResourceViewUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, org.ednovo.gooru.client.mvp.shelf.collection.tab.resource.exists.ExistsResourceView>, org.ednovo.gooru.client.mvp.shelf.collection.tab.resource.exists.ExistsResourceView.ExistsResourceViewUiBinder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final org.ednovo.gooru.client.mvp.shelf.collection.tab.resource.exists.ExistsResourceView owner) {
   ...
   */
  class Widgets {
    private final org.ednovo.gooru.client.mvp.shelf.collection.tab.resource.exists.ExistsResourceView owner;


    final com.google.gwt.event.dom.client.ClickHandler handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1 = new com.google.gwt.event.dom.client.ClickHandler() {
      public void onClick(com.google.gwt.event.dom.client.ClickEvent event) {
        owner.onClickReport(event);
      }
    };

    public Widgets(final org.ednovo.gooru.client.mvp.shelf.collection.tab.resource.exists.ExistsResourceView owner) {
      this.owner = owner;
      build_res();  // more than one getter call detected. Type: IMPORTED, precedence: 1
      build_domId11();  // more than one getter call detected. Type: DOM_ID_HOLDER, precedence: 10
      build_domId10();  // more than one getter call detected. Type: DOM_ID_HOLDER, precedence: 9
      build_domId12();  // more than one getter call detected. Type: DOM_ID_HOLDER, precedence: 9
      ...
      build_domId11Element();  // more than one getter call detected. Type: DEFAULT, precedence: 10
      build_domId10Element();  // more than one getter call detected. Type: DEFAULT, precedence: 9
      build_domId12Element();  // more than one getter call detected. Type: DEFAULT, precedence: 9
    ...
    SafeHtml template_html5() {
      return template.html5(get_domId10(), get_domId12());
    }
    SafeHtml template_html6() {
      return template.html6(get_domId9(), get_domId13());
    }
    SafeHtml template_html7() {
      return template.html7(get_domId8());
    }
    SafeHtml template_html8() {
      return template.html8(get_domId5(), get_domId6(), get_domId7());
    }
    SafeHtml template_html9() {
      return template.html9(get_domId17());
    }
    SafeHtml template_html10() {
      return template.html10(get_domId16());
    }
    SafeHtml template_html11() {
      return template.html11(get_domId15(), get_domId18());
    }
    SafeHtml template_html12() {
      return template.html12(get_domId21());
    }
    SafeHtml template_html13() {
      return template.html13(get_domId2(), get_domId4(), get_domId14(), get_domId19(), get_domId20());
    }
    SafeHtml template_html14() {
      return template.html14(get_domId1());
    }
     ...
     */
    private org.ednovo.gooru.client.mvp.shelf.collection.tab.resource.exists.ExistsResourceView_ExistsResourceViewUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private org.ednovo.gooru.client.mvp.shelf.collection.tab.resource.exists.ExistsResourceView_ExistsResourceViewUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final org.ednovo.gooru.client.mvp.shelf.collection.tab.resource.exists.ExistsResourceView_ExistsResourceViewUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (org.ednovo.gooru.client.mvp.shelf.collection.tab.resource.exists.ExistsResourceView_ExistsResourceViewUiBinderImpl_GenBundle) GWT.create(org.ednovo.gooru.client.mvp.shelf.collection.tab.resource.exists.ExistsResourceView_ExistsResourceViewUiBinderImpl_GenBundle.class);
      // Setup section.
    ...
    /**
     * Getter for res called 23 times. Type: IMPORTED. Build precedence: 1.
     */
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel2() {
      ...
      // Setup section.
      f_HTMLPanel2.setStyleName("" + get_res().css().resourceExistsPopupPopupOuterContainer() + "");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord443 = UiBinderUtil.attachToDom(f_HTMLPanel2.getElement());
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel3() {
      // Creation section.
      final com.google.gwt.user.client.ui.HTMLPanel f_HTMLPanel3 = new com.google.gwt.user.client.ui.HTMLPanel(template_html14().asString());
      // Setup section.
      f_HTMLPanel3.setStyleName("" + get_res().css().resourceExistsPopupContainer() + "");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord444 = UiBinderUtil.attachToDom(f_HTMLPanel3.getElement());
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel4() {
      ...
      // Setup section.
      f_HTMLPanel4.setStyleName("" + get_res().css().resourceExistsPopup() + "");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord445 = UiBinderUtil.attachToDom(f_HTMLPanel4.getElement());
      ...
      f_HTMLPanel4.addAndReplaceElement(get_f_HTMLPanel6(), get_domId4Element().get());
      f_HTMLPanel4.addAndReplaceElement(get_buttonContainer(), get_domId14Element().get());
      f_HTMLPanel4.addAndReplaceElement(get_loadingTextLbl(), get_domId19Element().get());
      f_HTMLPanel4.addAndReplaceElement(get_f_HTMLPanel13(), get_domId20Element().get());
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel5() {
      ...
      // Setup section.
      f_HTMLPanel5.setStyleName("" + get_res().css().resourceExistsPopupBlackBg() + "");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord446 = UiBinderUtil.attachToDom(f_HTMLPanel5.getElement());
      get_domId3Element().get();

      // Detach section.
      attachRecord446.detach();
      f_HTMLPanel5.addAndReplaceElement(get_alreadyExistsText(), get_domId3Element().get());
    ...
    /**
     * Getter for alreadyExistsText called 1 times. Type: DEFAULT. Build precedence: 6.
     */
    private com.google.gwt.user.client.ui.HTMLPanel get_alreadyExistsText() {
      return build_alreadyExistsText();
    }
    private com.google.gwt.user.client.ui.HTMLPanel build_alreadyExistsText() {
      // Creation section.
      final com.google.gwt.user.client.ui.HTMLPanel alreadyExistsText = new com.google.gwt.user.client.ui.HTMLPanel(template_html1().asString());
      // Setup section.
      alreadyExistsText.setStyleName("" + get_res().css().resourceExistsPopupTitle() + "");


      owner.alreadyExistsText = alreadyExistsText;

      return alreadyExistsText;
    }
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel6() {
      ...
      // Setup section.
      f_HTMLPanel6.setStyleName("" + get_res().css().resourceExistsPopupFormContainer() + "");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord447 = UiBinderUtil.attachToDom(f_HTMLPanel6.getElement());
      ...
      f_HTMLPanel6.addAndReplaceElement(get_resourceExistsText(), get_domId5Element().get());
      f_HTMLPanel6.addAndReplaceElement(get_resourceUrlLbl(), get_domId6Element().get());
    ...
    /**
     * Getter for resourceExistsText called 1 times. Type: DEFAULT. Build precedence: 6.
     */
    private com.google.gwt.user.client.ui.HTMLPanel get_resourceExistsText() {
      return build_resourceExistsText();
    }
    private com.google.gwt.user.client.ui.HTMLPanel build_resourceExistsText() {
      // Creation section.
      final com.google.gwt.user.client.ui.HTMLPanel resourceExistsText = new com.google.gwt.user.client.ui.HTMLPanel(template_html3().asString());
      // Setup section.
      resourceExistsText.setStyleName("" + get_res().css().resourceExistsPopupFormTitle() + "");


      owner.resourceExistsText = resourceExistsText;

      return resourceExistsText;
    }
    ...
    /**
     * Getter for resourceUrlLbl called 1 times. Type: DEFAULT. Build precedence: 6.
     */
    private com.google.gwt.user.client.ui.Label get_resourceUrlLbl() {
      return build_resourceUrlLbl();
    }
    private com.google.gwt.user.client.ui.Label build_resourceUrlLbl() {
      // Creation section.
      final com.google.gwt.user.client.ui.Label resourceUrlLbl = (com.google.gwt.user.client.ui.Label) GWT.create(com.google.gwt.user.client.ui.Label.class);
      // Setup section.
      resourceUrlLbl.setStyleName("" + get_res().css().resourceExistsPopupFormTitle() + "");


      owner.resourceUrlLbl = resourceUrlLbl;

      return resourceUrlLbl;
    }
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel7() {
      ...
      // Setup section.
      f_HTMLPanel7.setStyleName("" + get_res().css().resourceExistsPopupRoundedCorner() + "");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord448 = UiBinderUtil.attachToDom(f_HTMLPanel7.getElement());
      get_domId8Element().get();

      // Detach section.
      attachRecord448.detach();
      f_HTMLPanel7.addAndReplaceElement(get_f_HTMLPanel8(), get_domId8Element().get());
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel8() {
      ...
      // Setup section.
      f_HTMLPanel8.setStyleName("" + get_res().css().resourceExistsPopupRoundedCornerThumbimgContainer() + "");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord449 = UiBinderUtil.attachToDom(f_HTMLPanel8.getElement());
      get_domId9Element().get();
      get_domId13Element().get();

      // Detach section.
      attachRecord449.detach();
      f_HTMLPanel8.addAndReplaceElement(get_f_HTMLPanel9(), get_domId9Element().get());
      f_HTMLPanel8.addAndReplaceElement(get_resourceTitleLbl(), get_domId13Element().get());
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel9() {
      ...
      // Setup section.
      f_HTMLPanel9.setStyleName("" + get_res().css().resourceExistsPopupRoundedCornerThumbimg() + "");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord450 = UiBinderUtil.attachToDom(f_HTMLPanel9.getElement());
      get_domId10Element().get();
      get_domId12Element().get();

      // Detach section.
      attachRecord450.detach();
      f_HTMLPanel9.addAndReplaceElement(get_f_HTMLPanel10(), get_domId10Element().get());
      f_HTMLPanel9.addAndReplaceElement(get_resourceThumbnailImg(), get_domId12Element().get());

      return f_HTMLPanel9;
    }

    /**
     * Getter for domId10 called 2 times. Type: DOM_ID_HOLDER. Build precedence: 9.
     */
    ...
    /**
     * Getter for f_HTMLPanel10 called 1 times. Type: DEFAULT. Build precedence: 9.
     */
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel10() {
      // Creation section.
      final com.google.gwt.user.client.ui.HTMLPanel f_HTMLPanel10 = new com.google.gwt.user.client.ui.HTMLPanel(template_html4().asString());
      // Setup section.
      f_HTMLPanel10.setStyleName("" + get_res().css().resourceExistsPopupSpriteVideoContainer() + "");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord451 = UiBinderUtil.attachToDom(f_HTMLPanel10.getElement());
      get_domId11Element().get();

      // Detach section.
      attachRecord451.detach();
      f_HTMLPanel10.addAndReplaceElement(get_resourceIconImg(), get_domId11Element().get());

      return f_HTMLPanel10;
    }

    /**
     * Getter for domId11 called 2 times. Type: DOM_ID_HOLDER. Build precedence: 10.
     */
    ...
    /**
     * Getter for resourceIconImg called 1 times. Type: DEFAULT. Build precedence: 10.
     */
    private com.google.gwt.user.client.ui.Image get_resourceIconImg() {
      return build_resourceIconImg();
    }
    private com.google.gwt.user.client.ui.Image build_resourceIconImg() {
      // Creation section.
      final com.google.gwt.user.client.ui.Image resourceIconImg = (com.google.gwt.user.client.ui.Image) GWT.create(com.google.gwt.user.client.ui.Image.class);
      // Setup section.
      resourceIconImg.setStyleName("" + get_res().css().resourceExistsResourceTypeSprite() + " " + get_res().css().resourceExistsPopupSpriteVideo() + "");


      owner.resourceIconImg = resourceIconImg;

      return resourceIconImg;
    }

    /**
     * Getter for domId11Element called 2 times. Type: DEFAULT. Build precedence: 10.
     */
    ...
    /**
     * Getter for domId10Element called 2 times. Type: DEFAULT. Build precedence: 9.
     */
    ...
    /**
     * Getter for domId12 called 2 times. Type: DOM_ID_HOLDER. Build precedence: 9.
     */
    ...
    /**
     * Getter for resourceThumbnailImg called 1 times. Type: DEFAULT. Build precedence: 9.
     */
    private com.google.gwt.user.client.ui.Image get_resourceThumbnailImg() {
      return build_resourceThumbnailImg();
    }
    private com.google.gwt.user.client.ui.Image build_resourceThumbnailImg() {
      // Creation section.
      final com.google.gwt.user.client.ui.Image resourceThumbnailImg = (com.google.gwt.user.client.ui.Image) GWT.create(com.google.gwt.user.client.ui.Image.class);
      // Setup section.
      resourceThumbnailImg.setStyleName("");
      resourceThumbnailImg.setHeight("60");
      resourceThumbnailImg.setWidth("80");


      owner.resourceThumbnailImg = resourceThumbnailImg;

      return resourceThumbnailImg;
    }

    /**
     * Getter for domId12Element called 2 times. Type: DEFAULT. Build precedence: 9.
     */
    ...
    /**
     * Getter for resourceTitleLbl called 1 times. Type: DEFAULT. Build precedence: 8.
     */
    private com.google.gwt.user.client.ui.Label get_resourceTitleLbl() {
      return build_resourceTitleLbl();
    }
    private com.google.gwt.user.client.ui.Label build_resourceTitleLbl() {
      // Creation section.
      final com.google.gwt.user.client.ui.Label resourceTitleLbl = (com.google.gwt.user.client.ui.Label) GWT.create(com.google.gwt.user.client.ui.Label.class);
      // Setup section.
      resourceTitleLbl.setStyleName("" + get_res().css().resourceExistsPopupRoundedCornerThumbHeading() + "");
    ...
    /**
     * Getter for buttonContainer called 1 times. Type: DEFAULT. Build precedence: 5.
     */
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_buttonContainer() {
      // Creation section.
      final com.google.gwt.user.client.ui.HTMLPanel buttonContainer = new com.google.gwt.user.client.ui.HTMLPanel(template_html11().asString());
      // Setup section.
      buttonContainer.setStyleName("" + get_res().css().resourceExistsPopupBlueButtonContainer() + "");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord452 = UiBinderUtil.attachToDom(buttonContainer.getElement());
      get_domId15Element().get();
      get_domId18Element().get();

      // Detach section.
      attachRecord452.detach();
      buttonContainer.addAndReplaceElement(get_f_HTMLPanel11(), get_domId15Element().get());
      buttonContainer.addAndReplaceElement(get_cancelExistsResourcePopupBtnLbl(), get_domId18Element().get());
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel11() {
      // Creation section.
      final com.google.gwt.user.client.ui.HTMLPanel f_HTMLPanel11 = new com.google.gwt.user.client.ui.HTMLPanel(template_html10().asString());
      // Setup section.
      f_HTMLPanel11.setStyleName("" + get_res().css().resourceExistsPopupBluebg() + "");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord453 = UiBinderUtil.attachToDom(f_HTMLPanel11.getElement());
      get_domId16Element().get();

      // Detach section.
      attachRecord453.detach();
      f_HTMLPanel11.addAndReplaceElement(get_f_HTMLPanel12(), get_domId16Element().get());
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel12() {
      ...
      // Setup section.
      f_HTMLPanel12.setStyleName("" + get_res().css().resourceExistsPopupBlue_Ok() + "");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord454 = UiBinderUtil.attachToDom(f_HTMLPanel12.getElement());
      get_domId17Element().get();

      // Detach section.
      attachRecord454.detach();
      f_HTMLPanel12.addAndReplaceElement(get_addExistsResourceBtnLbl(), get_domId17Element().get());
    ...
    /**
     * Getter for addExistsResourceBtnLbl called 1 times. Type: DEFAULT. Build precedence: 8.
     */
    private com.google.gwt.user.client.ui.Label get_addExistsResourceBtnLbl() {
      return build_addExistsResourceBtnLbl();
    }
    private com.google.gwt.user.client.ui.Label build_addExistsResourceBtnLbl() {
      // Creation section.
      final com.google.gwt.user.client.ui.Label addExistsResourceBtnLbl = (com.google.gwt.user.client.ui.Label) GWT.create(com.google.gwt.user.client.ui.Label.class);
      // Setup section.
      addExistsResourceBtnLbl.setStyleName("" + get_res().css().resourceExistsPopupBlue_OkTitle() + "");


      owner.addExistsResourceBtnLbl = addExistsResourceBtnLbl;

      return addExistsResourceBtnLbl;
    }
    ...
    /**
     * Getter for cancelExistsResourcePopupBtnLbl called 1 times. Type: DEFAULT. Build precedence: 6.
     */
    private com.google.gwt.user.client.ui.Label get_cancelExistsResourcePopupBtnLbl() {
      return build_cancelExistsResourcePopupBtnLbl();
    }
    private com.google.gwt.user.client.ui.Label build_cancelExistsResourcePopupBtnLbl() {
      // Creation section.
      final com.google.gwt.user.client.ui.Label cancelExistsResourcePopupBtnLbl = (com.google.gwt.user.client.ui.Label) GWT.create(com.google.gwt.user.client.ui.Label.class);
      // Setup section.
      cancelExistsResourcePopupBtnLbl.setStyleName("" + get_res().css().resourceExistsPopupBlue_Cancel() + "");


      owner.cancelExistsResourcePopupBtnLbl = cancelExistsResourcePopupBtnLbl;

      return cancelExistsResourcePopupBtnLbl;
    }
    ...
    /**
     * Getter for loadingTextLbl called 1 times. Type: DEFAULT. Build precedence: 5.
     */
    ...
    private com.google.gwt.user.client.ui.Label build_loadingTextLbl() {
      ...
      // Setup section.
      loadingTextLbl.setStyleName("" + get_res().css().resourceExistsPopupBlueButtonContainer() + "");
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_f_HTMLPanel13() {
      ...
      // Setup section.
      f_HTMLPanel13.setStyleName("" + get_res().css().reportResourceContainer() + "");

      // Attach section.
      UiBinderUtil.TempAttachment attachRecord455 = UiBinderUtil.attachToDom(f_HTMLPanel13.getElement());
      get_domId21Element().get();

      // Detach section.
      attachRecord455.detach();
      f_HTMLPanel13.addAndReplaceElement(get_reportResInfoLbl(), get_domId21Element().get());
    ...
    /**
     * Getter for reportResInfoLbl called 1 times. Type: DEFAULT. Build precedence: 6.
     */
    private com.google.gwt.user.client.ui.Anchor get_reportResInfoLbl() {
      return build_reportResInfoLbl();
    }
    private com.google.gwt.user.client.ui.Anchor build_reportResInfoLbl() {
      // Creation section.
      final com.google.gwt.user.client.ui.Anchor reportResInfoLbl = (com.google.gwt.user.client.ui.Anchor) GWT.create(com.google.gwt.user.client.ui.Anchor.class);
      // Setup section.
      reportResInfoLbl.setStyleName("" + get_res().css().reportResource() + "");
      reportResInfoLbl.setTarget("_blank");
      reportResInfoLbl.addClickHandler(handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1);


      owner.reportResInfoLbl = reportResInfoLbl;

      return reportResInfoLbl;
    }
