...
public interface ResourcePlayerHeaderView_CollectionPlayerHeaderViewUiBinderImpl_GenCss_headerStyle extends CssResource {
  String progress();
  ...
  String tooltipText();
  String header();
  @ClassName("player-studentview-button")
  String playerStudentviewButton();
  String loggedOut();
