 ...
 */
public class GoogleAnalyticsHpNavigationTracker implements NavigationHandler {
  private final GoogleAnalytics analytics;

  @Inject
  public GoogleAnalyticsHpNavigationTracker(@GaAccount final String gaAccount,
    ...
    if (GWT.isScript()) {
      Scheduler.get().scheduleDeferred(new ScheduledCommand() {
        ...
        public void execute() {
        	...
        	eventBus.addHandler(NavigationEvent.getType(), GoogleAnalyticsHpNavigationTracker.this);
        }
      });
    }
  }
