...
public class LibraryImagesMap {
	   ...
	   static Map<String, List<String>> mapObj=new HashMap<String, List<String>>();
	   ...
	   private LibraryImagesMap(){
			...
			mapObj.put(PlaceTokens.LUSD, Arrays.asList(i18n.GL2181_1(), PlaceTokens.LUSD,"lusdLogo"));
			...
			mapObj.put(PlaceTokens.SAUSD_LIBRARY, Arrays.asList(i18n.GL1902(), PlaceTokens.SAUSD_LIBRARY,"sausdLogo"));
			...
			mapObj.put(PlaceTokens.TICAL, Arrays.asList(i18n.GL2186_1(),PlaceTokens.TICAL,"ticalLogo"));
