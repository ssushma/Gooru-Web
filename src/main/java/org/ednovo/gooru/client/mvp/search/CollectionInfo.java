...
public class CollectionInfo extends Composite {
	...
	private void setStaticText() {
		...
		lblCentury.setText(i18n.GL3199()+i18n.GL_SPL_SEMICOLON()+" ");
		lblCentury.getElement().setId("lblCentury");
		lblCentury.getElement().setAttribute("alt",i18n.GL3199()+i18n.GL_SPL_SEMICOLON()+" ");
		lblCentury.getElement().setAttribute("title",i18n.GL3199()+i18n.GL_SPL_SEMICOLON()+" ");
