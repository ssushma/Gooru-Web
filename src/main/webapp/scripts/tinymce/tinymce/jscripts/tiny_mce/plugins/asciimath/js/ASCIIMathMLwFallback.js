...
function AMTparseMath(str) {
	if(str.indexOf("title")!=-1){// this will fix image load on setContent raw data
		  var mathValue=document.getElementById("fakeDiv");
		  mathValue.innerHTML=str;
		  var mathValueContainer=document.getElementById("fakeDiv");
		  var imageContainer=mathValueContainer.firstChild;
		  str=imageContainer.getAttribute("title");
		  //return str;
	  }
  str = str.replace(/(&nbsp;|\u00a0|&#160;)/g,"");
  str = str.replace(/&gt;/g,">");
